...
import br.com.movieapp.core.util.UtilFunctions.logError
import br.com.movieapp.features.movie.presentation.components.MovieItem
                ...
                when {
                    ...
                    loadState.refresh is LoadState.Error -> {
                        ...
                        item(span = { GridItemSpan(maxLineSpan) }) {
                            ...
                            logError(tag = "Erro carregamento -> ", e.error.message)
                        }
                    }
